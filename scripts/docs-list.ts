#!/usr/bin/env tsx
// Stable docs router: enumerates markdown in docs (excluding archive/research), extracts summary and read_when from front matter, and flags missing metadata so agents know exactly which guides to open before working.
