...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 `./scripts/docs-list.ts` lists `docs/web-ref/web-ref-intake.md` and the summary line still renders in the docs list output.
- [ ] #2 `docs/web-ref/web-ref-intake.md` contains an explicit output inventory list that includes the exact strings `dom.html`, `page-dump.json`, `styles/`, `assets.json`, `tokens.json`, and `screenshots/`.
- [ ] #3 `docs/web-ref/web-ref-intake.md` contains a dedicated page-dump pointer paragraph mentioning `paths`, `sections`, and `components` as keys.
<!-- AC:END -->
